...
<h3 class="page-title">Rekapitulasi Nilai</h3>
...
<table class="table table-striped">
		...
		<tr>
			<th>Kondite</th>
			<td><input type="text" class="form-control" readonly required></td>
			<td><input type="text" class="form-control" readonly required></td>
			<td><input type="text" class="form-control" readonly required></td>
			<td><input type="text" class="form-control" readonly required></td>
			<td><input type="text" class="form-control" readonly required></td>
      ...
      $nim = $_SESSION['nim'];
      $query = "SELECT * FROM nilaiakademik WHERE nim = '$nim' AND semester = '1';";
      $nyambung = mysqli_query($koneksi,$query);
      $cek =  mysqli_num_rows($nyambung);
      
      $awal=0;
	    while($data = mysqli_fetch_assoc($nyambung)){
	    	$awal += $data['angka'];
	    }
	    $jumlah1 = $awal/$cek;
	    echo $jumlah1;
	    $_SESSION['jumlah1'] = $jumlah1;
      ...
      $nim = $_SESSION['nim'];
      $query = "SELECT * FROM nilaiakademik WHERE nim = '$nim' AND semester = '2';";
      $nyambung = mysqli_query($koneksi,$query);
      $cek =  mysqli_num_rows($nyambung);
      ...
      $nim = $_SESSION['nim'];
      $query = "SELECT * FROM nilaiakademik WHERE nim = '$nim' AND semester = '3';";
      $nyambung = mysqli_query($koneksi,$query);
      $cek =  mysqli_num_rows($nyambung);
      ...
      $nim = $_SESSION['nim'];
      $query = "SELECT * FROM nilaiakademik WHERE nim = '$nim' AND semester = '4';";
      $nyambung = mysqli_query($koneksi,$query);
      $cek =  mysqli_num_rows($nyambung);
      ...
      $nim = $_SESSION['nim'];
      $query = "SELECT * FROM nilaiakademik WHERE nim = '$nim' AND semester = '5';";
      $nyambung = mysqli_query($koneksi,$query);
      $cek =  mysqli_num_rows($nyambung);
      ...
      $awal=0;
	    ...
	    $jumlah5 = $awal/$cek;
	    echo $jumlah5;
	    $_SESSION['jumlah5'] = $jumlah5;
    
      ?>"
			 readonly required></td>
			<td><input type="number" class="form-control" value="<?php
			$_SESSION['jumlah6'] = $jumlah6;
			?>
				" 
				readonly required></td>

			<td><input type="number" class="form-control" value="<?php 
			$jumlah1 = $_SESSION['jumlah1'];
			$jumlah2 = $_SESSION['jumlah2'];
			$jumlah3 = $_SESSION['jumlah3'];
			$jumlah4 = $_SESSION['jumlah4'];
			$jumlah5 = $_SESSION['jumlah5'];
			$jumlah6 = $_SESSION['jumlah6'];

			if($jumlah2 <= 0 && $jumlah3 <= 0 && $jumlah4 <= 0 && $jumlah5 <= 0 && $jumlah6 <= 0 ){
				echo $jumlah1;
			}elseif($jumlah3 <= 0 && $jumlah4 <= 0 && $jumlah5 <= 0 && $jumlah6 <= 0 ){
				$total = ($jumlah1 + $jumlah2)/2;
				echo $total;
			}elseif($jumlah4 <= 0 && $jumlah5 <= 0 && $jumlah6 <= 0 ){
				$total = ($jumlah1 + $jumlah2 + $jumlah3)/3;
				echo $total;
			}elseif($jumlah5 <= 0 && $jumlah6 <= 0 ){
				$total = ($jumlah1 + $jumlah2 + $jumlah3 + $jumlah4)/4;
				echo $total;
			}elseif($jumlah6 <= 0 ){
				$total = ($jumlah1 + $jumlah2 + $jumlah3 + $jumlah4 + $jumlah5)/5;
				echo $total;
			}else{
				$total = ($jumlah1 + $jumlah2 + $jumlah3 + $jumlah4 + $jumlah5 + $jumlah6)/6;
				echo $total;
			}
		...
		<tr>
			<th colspan="7" align="right">IP Kelulusan</th>
			<td><input type="text" class="form-control" readonly required></td>
		</tr>
	</table>
</div>						
