...
<body>
	...
	<!-- MAIN -->
		...
		<h3 class="page-title" style="margin-top: 20px; margin-bottom: -10px">Kartu Hasil Study</h3>									
		</div>
...
if (isset($_GET['semester'])) {
	...
	$sql = mysqli_query($koneksi, "SELECT kodemk, namamk, dosen, sks, angka, huruf FROM nilaiakademik WHERE nim = '$nim' AND semester = '$semester';") or die(mysqli_error($koneksi));
...
<div class="form-group row">
    ...
    <input type="text" readonly="" value="<?php 
 	...
 	<div class="form-group row">	
		<label for="inputPassword3" class="col-sm-4 col-form-label" style="font-size: 15px;">Tahun Ademik</label>
								<div class="col-sm-6">
...
<div class="text-right"><button type="submit" class="btn btn-success"><i class="fa fa-check-circle"></i> Lihat Nilai</button></div><br>
	
<div class="form-group row">						
	<label for="inputPassword3" class="col-sm-4 col-form-label" style="font-size: 15px;">Jumlah SKS</label>
    <div class="col-sm-4">
    <input type="text" readonly="" value="<?php 
    if (isset($_GET['semester'])) {
      $nim = $_SESSION['nim'];
      $semester=trim($_GET['semester']);
      $query = "SELECT * FROM nilaiakademik WHERE nim = '$nim' AND semester = '$semester';";
...
<div class="form-group row">						
	<label for="inputPassword3" class="col-sm-4 col-form-label" style="font-size: 15px;">IP Akademik</label>
    <div class="col-sm-4">
    <input type="text" readonly="" value="<?php 
    if (isset($_GET['semester'])) {
      $nim = $_SESSION['nim'];
...
<div class="form-group row">						
	<label for="inputPassword3" class="col-sm-4 col-form-label" style="font-size: 15px;">IP Kedisiplinan</label>
    <div class="col-sm-4">
...
<div class="form-group row">						
	<label for="inputPassword3" class="col-sm-4 col-form-label" style="font-size: 15px;">IP Magang</label>
    <div class="col-sm-4">
    <input type="text" readonly="" value=""
    class="form-control">
    </div>
