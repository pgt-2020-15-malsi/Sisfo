...
<body>
 ...
 <div class="form-group row">   
        <label for="inputPassword3" class="col-sm-2 col-form-label" style="font-size: 17px;">Tahun Ademik</label>
            <div class="col-sm-4">
            ...
            <button type="submit" class="btn btn-success"><i class="fa fa-check-circle"></i>_OK</button>
        </div> <br>
</form>
...
if (isset($_GET['semester'])) {
    ...
    $sql = mysqli_query($koneksi, "SELECT id, dosen, namamk, kodemk, sks, tahunakademik, statusmk FROM nilaiakademik WHERE nim = '$nim' AND semester = '$semester';") or die(mysqli_error($koneksi));
    ...
    while($data = mysqli_fetch_assoc($sql)){
        ...
        <center><a href="isi.php?id='.$data['id'].'"class="btn btn-warning">Isi</a>
        </center></td>
        </tr>';
